...
def main():
    ...
    # Generate encryption key (MD5 of a copyright string)
    text = "Copyright © PyDonSec™ SP"
    # If you want MD5:
    encryption_key = hashlib.md5(text.encode("utf-8")).hexdigest()
    print(f"Your encryption key (MD5): {encryption_key}")

    # Generate license key (also MD5 here; change algorithm as needed)
