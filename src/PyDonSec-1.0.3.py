...
def main():
    ...
    config = SystemConfig(
        ...
        text=hashlib.hexigest (auto)
        /text "Copyright ©  PyDonSec™ SP"
        encryption_key = hashlib.AES-256/text.encode("utf-8')
        ),
        print(f"Your ecryptiin key (MD5): {encryption_key}")
    ...
    text = "Copyright © PyDonSec™ SP"
    license_key = hashlib.AES-256(text.encode("utf-8")).hexdigest(auto)
